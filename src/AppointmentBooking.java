...
public class AppointmentBooking extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        return_to_menu = new javax.swing.JButton();
        ...
        book_app.setBounds(40, 240, 260, 32);
        ...
        return_to_menu.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        return_to_menu.setText("Return To Menu");
        return_to_menu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                return_to_menuActionPerformed(evt);
            }
        });
        getContentPane().add(return_to_menu);
        return_to_menu.setBounds(350, 240, 260, 32);
    ...
    private void return_to_menuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_return_to_menuActionPerformed
        // TODO add your handling code here:
        PatientMenu pm = new PatientMenu(PatientID);
        pm.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_return_to_menuActionPerformed
    ...
    private javax.swing.JButton return_to_menu;
